...
3. Adsorb on the Asymmetric Surface at up to 3 adsorbate coverages -
      ...
      d. Modify the Adsorption file (in the last few lines) to have YOUR_FACET and the indices of the atoms you want to adsorb on top of: ```nano /home/x-rthatcher/scripts_Final_Project/asymmetric_slabs/Adsorptions_Asymmetric.py ```
